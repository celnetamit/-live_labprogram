...
export async function GET() {
  try {
    const keepSlugs = ["cognicore-ai", "denovo-genai-lab", "ai-6g", "fraudshield", "logiclab", "micro-ai", "battery-ai", "virtual-ai", "smartfactory-ai", "ai-program-navigator", "drugdiscovery-ai"];
